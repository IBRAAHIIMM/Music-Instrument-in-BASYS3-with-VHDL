...
HD_PWD='D:/OLD Desktops/Desktop Karadere/Vivado Projects/Term_Project/Term_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_music.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_music.tcl
